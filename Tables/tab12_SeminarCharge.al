    ...
    fields
    {
        ...
        field(3; Type; Option)
        {
            ...
            var
                OldType: Integer;
            begin
                //whenever a table has a conditional relationship, you need to reset any fields defaulted from one relationship, whenever tha value in the conditional field changes

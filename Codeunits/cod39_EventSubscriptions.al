...
// Chapter 7 - Lab 4-4
{
    ...
    begin
        ...
        if PostedSeminarRegHeader.ReadPermission then begin  //checks whether the user has permision to read from the table that is being searched
            ...
            with DocumentEntry do begin  //uses record variable from the temporary Document Entry table
                ...
                if FindLast then
                    ...
                    NextEntryNo := 1;
                Init;  //initializes the record on the table
                ...
                Insert;  //inserts the record into the table without executing the code in OnInsert trigger
            end;
        end;
